    ...
    .then(response => {
      ...
      response.data.forEach(element => {
        output += `<div class="card meetup-menu-item">
                      ...
                      <p class="meetup"><i class="fas fa-map-marker-alt"></i> ${element.location}</p>
                      <p class="meetup"><i class="fas fa-calendar-alt"></i> ${moment(element.happeningon).format("MMMM Do YYYY, h:mm:ss a")}</p>
