...
describe('/Meetups Resources', () => {
  ...
  describe('DELETE /meetup/<id>', () => {
    it('its should delete specific meetup ', (done) => {
      chai
        .request(app)
    ...
    it('its should send error deleting specific meetup ', (done) => {
      chai
        .request(app)
...
describe('UnAuthorized', () => {
  ...
  describe('User Request Admin Route', () => {
    ...
    describe('GET /RSVP ', () => {
      it('Should return All Meetups a User RSVP', (done) => {
        chai
          .request(app)
      ...
      it('Should return error for Invalid meetup', (done) => {
        chai
          .request(app)
          .get('/api/v1/meetups/rsvps')
          .set('Authorization', userToken)
